...
function NavigationLinks({showBurgerMenuStyle, onClose}) {
  return (
    <>
      <div className={`navigation__block-movies ${showBurgerMenuStyle ? 'navigation__block-movies_type_burger' : ''}`}>
        <li className='navigation__link'>
          <NavLink to={'/movies'}
                   onClick={onClose}
                   className={({isActive}) => `navigation__link-item
                   ${showBurgerMenuStyle ? 'navigation__link-item_type_burger' : ''}
                   ${isActive && 'navigation__link-item_active'}`}>Фильмы
          </NavLink>
        </li>
        <li className='navigation__link'>
          <NavLink to={'/saved-movies'}
                   ...
                   ${showBurgerMenuStyle ? 'navigation__link-item_type_burger' : ''}`}>Сохраненные фильмы
          </NavLink>
        </li>
      </div>
