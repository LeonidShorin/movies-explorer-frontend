  ...
  return (
   <>
      ...
      <Routes>
        ...
        <Route path={'/movies'} element={<Movies isLoggedIn={isLoggedIn} onLike={toggleLike} isLiked={isLiked}/>}> </Route>
        <Route path={'/saved-movies'} element={<SavedMovies isLoggedIn={isLoggedIn}/>}> </Route>
        <Route path={'/profile'} element={<Profile onEditProfile={handleEditProfile} isEditProfile={isEditProfile} onFormSubmit={handleFormSubmit}/>}> </Route>
        <Route path={'/signup'} element={<Register/>}> </Route>
        <Route path={'/signin'} element={<Login/>}> </Route>
        <Route path={'/404'} element={<NotFound/>}> </Route>
        <Route path={'*'} element={<NotFound/>}> </Route>
      </Routes>
      <Footer isLoggedIn={isLoggedIn} onLogOut={handleLogOut} isEditProfile={isEditProfile}/>
   </>
  );
}
